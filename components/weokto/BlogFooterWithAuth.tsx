...
const BlogFooterWithAuth = memo(function BlogFooterWithAuth() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-8 grid grid-cols-1 md:grid-cols-4 gap-6 text-xs">
            ...
            <div>
              ...
              <ul className="space-y-1">
                <li>
                  <Link href="/blog?category=success-stories" className="text-[#B794F4] hover:text-[#FFB000] transition-colors">
                    SUCCESS STORIES
                  </Link>
                </li>
                <li>
                  <Link href="/blog?category=tutoriels" className="text-[#B794F4] hover:text-[#FFB000] transition-colors">
                    TUTORIELS
                  </Link>
                </li>
                <li>
                  <Link href="/blog?category=annonces" className="text-[#B794F4] hover:text-[#FFB000] transition-colors">
                    ANNONCES
                  </Link>
                </li>
              </ul>
...
export default BlogFooterWithAuth
